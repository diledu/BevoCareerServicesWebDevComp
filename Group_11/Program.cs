...
String connectionString = "Server=tcp:sp25group11.database.windows.net,1433;Initial Catalog=sp25group11;Persist Security Info=False;User ID=MISAdmin;Password=MIS12345!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
...
//NOTE: ADDED System date
builder.Services.AddSingleton<SysDate, CustomDateTimeProvider>();
